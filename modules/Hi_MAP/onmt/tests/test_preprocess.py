...
default_opts = [
    '-data_type', 'text',
    '-train_src', 'multi-news-original/train.src',
    '-train_tgt', 'multi-news-original/train.tgt',
    '-valid_src', 'multi-news-original/val.src',
    '-valid_tgt', 'multi-news-original/tgt.src',
